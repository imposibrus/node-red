...
module.exports = {
    ...
    // lost.
    credentialSecret: process.env.CREDS_SECRET,
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2b$08$zAW5m9F6pqY0ocDqv7BvBu0Ne5V0tjtSjwSpcxfcu4e/pWYVKr6pu",
            permissions: "*"
        }]
    },
    ...
    httpNodeAuth: {user:"user",pass:"$2b$08$pkL6Nm4c7u2U5Np8XNisPOJeFRNds3VIaXuiZyhxIdN5Uck8b/2Y6"},
